/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c31dfd2d5cea31a8a30b3fd6f5d538c9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_JOBS_PER_SCHEDULE">> {}
}
