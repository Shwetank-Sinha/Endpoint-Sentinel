/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7065be0ef26639ef2f376d6acc9a8a4e)
...
interface __BaseEnv_Env {
	...
	ALERT_QUEUE: Queue;
	ASSETS: Fetcher;
	PUBLIC_JURY_DEMO: "true";
	MAX_JOBS_PER_SCHEDULE: "100";
	INCIDENT_FAILURE_THRESHOLD: "2";
	INCIDENT_RECOVERY_THRESHOLD: "1";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_JURY_DEMO" | "MAX_JOBS_PER_SCHEDULE" | "INCIDENT_FAILURE_THRESHOLD" | "INCIDENT_RECOVERY_THRESHOLD" | "ALERT_WEBHOOK_FORMAT">> {}
}
