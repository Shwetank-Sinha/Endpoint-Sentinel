...
interface Props { endpoint: EndpointRecord; checking: boolean; queued: boolean; onCheck: () => void; onToggle: () => void; onDetails: () => void; onIncident: () => void; onDelete: () => void }
const formatTime = (value: Date | string) => new Date(value).toLocaleString();

export default function EndpointRecordCard({ endpoint, checking, queued, onCheck, onToggle, onDetails, onIncident, onDelete }: Props) {
